...
const fakeData = {
  ...
  securityAnalysis: [
    { engine: 'Viettel Threat Intelligence', category: 'Blacklist', result: 'Undetected', status: 'Caution' },
    { engine: 'VIPRE', category: 'Blacklist', result: 'Undetected', status: 'Caution' },
    { engine: 'Webroot', category: 'Blacklist', result: 'Undetected', status: 'Caution' },
    { engine: 'ZeroCERT', category: 'Blacklist', result: 'Undetected', status: 'Caution' },
    { engine: 'Zvelo', category: 'Blacklist', result: 'Undetected', status: 'Caution' },
    { engine: 'Xcitium Verdict Cloud', category: 'Blacklist', result: 'Undetected', status: 'Caution' },
    { engine: 'VirusTotal Results', category: 'Clean', result: 'Undetected', status: 'Clean' },
  ],
  ports: [
    { port: 80, service: 'HTTP', status: 'Open', riskLevel: 'Low Risk' },
    { port: 443, service: 'HTTPS', status: 'Open', riskLevel: 'Secure' },
    { port: 21, service: 'FTP', status: 'Closed', riskLevel: 'Safe' },
    { port: 22, service: 'SSH', status: 'Open', riskLevel: 'Risky' },
  ],
  protocols: [
    { protocol: 'TLS 1.2', status: 'Active', securityRating: 'Secure', recommendation: 'None' },
    { protocol: 'TLS 1.0', status: 'Inactive', securityRating: 'Weak', recommendation: 'Upgrade to TLS 1.2' },
    { protocol: 'SSH', status: 'Active', securityRating: 'Risky', recommendation: 'Close/Limit Access' },
  ],
};
